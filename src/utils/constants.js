export const constants = {
  ...
  name_bur: process.env.REACT_APP_TITLE_BUR || "Magix Support",
  ...
  hospital_logo2: process.env.REACT_APP_LOGO2,
  hospital_desc:
    process.env.REACT_APP_DESC || "Specialist Clinic and Diagnostic Center",
  hospital_desc_bur:
    process.env.REACT_APP_DESC_BUR ||
    "အထူးကုဆေးခန်း နှင့် အဆင့်မြင့်ရောဂါရှာဖွေရေးစင်တာ",
  primary_color: process.env.REACT_APP_THEME || "#1976d2",
  hospital_phones:
    process.env.REACT_APP_PHONES || "09-97-8396650, 09-94-3031598 (Viber)",
  hospital_phones_bur:
    process.env.REACT_APP_PHONES_BUR || "၀၉-၉၇-၈၃၉၆၆၅၀၊ ၀၉-၉၄-၃၀၃၁၅၉၈",
  hospital_address:
    process.env.REACT_APP_ADDRESS ||
    "No.3 A, Kan Taw Mon Housing, Lay Daung Kan Road, Thingangyun township (Near May Ka Housing)",
  hospital_address_bur:
    process.env.REACT_APP_ADDRESS_BUR ||
    "အမှတ် ၃ (အေ)၊ ကန်တော်မွန်အိမ်ရာ၊ လေးထောင့်ကန်လမ်း (မေခအိမ်ရာအနီး)၊ သင်္ဃန်းကျွန်းမြို့နယ်။",
